...
class UNet_Two(nn.Module):
    def __init__(self, in_channels=1, feature_scale=2, dropout=0.1):
        ...
        self.up1_f = decoder(filters[3], filters[2], dropout)
        self.up2_f = decoder(filters[2], filters[1], dropout)
        self.final_conv_f = nn.Sequential(nn.Conv2d(filters[1], filters[1], kernel_size=3, padding=1),
        ...
        self.down1 = encoder(1, filters[1], dropout)
