...
class UNet_Oetd(nn.Module):
    def __init__(self, in_channels=1, feature_scale=2, dropout=0.1):
        ...
        self.up1_l = decoder(filters[4], filters[3], dropout)
        self.up2_l = decoder(filters[3], filters[2], dropout)
        self.up3_l = decoder(filters[2], filters[1], dropout)
        ...
        self.up1_s = decoder(filters[4], filters[3], dropout)
        self.up2_s = decoder(filters[3], filters[2], dropout)
        self.up3_s = decoder(filters[2], filters[1], dropout)
